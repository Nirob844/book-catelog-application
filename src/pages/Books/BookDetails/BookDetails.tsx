      ...
      <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col max-w-screen-lg overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto">
          ...
          <div className="flex flex-col justify-center p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2">
            ...
            <p className="mb-5 text-gray-900">Authors: {author}</p>
            <p className="mb-5 text-gray-900">Publisher: {publicationDate}</p>
            ...
            <div>
              ...
              {bookReviews.map((review, index) => (
                <div key={index} className="mb-2">
                  <p className="text-gray-900">Rating: {review.rating} / 5</p>
                  <p className="text-gray-900">Comment: {review.comment}</p>
                </div>
              ))}
            </div>
          </div>
